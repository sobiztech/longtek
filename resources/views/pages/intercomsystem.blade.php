        ...
        <div class="wraper" data-aos="fade-up" data-aos-duration="500">
            ...
            <form name="new-intercom-form">
                <div class="row">
                    ...
                    <input type="text" name="service" class="form-control" placeholder="Intercom Systems" value="Intercom Systems" hidden/>
...
<!-- ==== FeaturesSectionS3 start ==== -->
<section class="features-section-s3 section_space">
        ...
        <div class="row justify-content-end">
            <div class="col-lg-7 col-12">
                <div class="features-content">
                    <div class="top_title">
                        <span><img src="assets/images/title-shap.png" alt="" />
                            Longtek Electronics Ltd</span>
                        <h2>Enhancing Communication Intercom Systems with Longtek Electronics</h2>
                        <p>At Longtek Electronics (Europe) Ltd, we specialize in the installation, maintenance, and repair of intercom systems
                            across Enfield Town and beyond.intercom system installed, routine maintenance, or emergency repairs,
                            Longtek Electronics Ltd offers reliable solutions backed by years of experience in the industry.
                        </p>
                    </div>
                    <div class="features-item">
                        <div class="icon">
                            <img src="assets/images/features/4.svg" alt="" />
                        </div>
                        <div class="text">
                            <h3>Installation, Maintenance & Repair Services</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="item">
                    ...
                    <div class="text">
                        ...
                        <p>Enables quick communication between office spaces, warehouses, and retail environments, improving operational efficiency.</p>
                    </div>
                    <div class="shape">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="item">
                    ...
                    <div class="text">
                        ...
                        <p>Enhances home security and facilitates seamless communication between different rooms, ensuring convenience and peace of mind for homeowners.</p>
                    </div>
                    <div class="shape">
                        <img src="assets/images/catagroeis/shape-2.png" alt="" />
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="item">
                    ...
                    <div class="text">
                        ...
                        <p>Used in factories and industrial facilities for safety announcements, monitoring production processes, and emergency communication.</p>
                    </div>
                    <div class="shape">
                        <img src="assets/images/catagroeis/shape-2.png" alt="" />
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-12">
                <div class="top_title">
                    ...
                    <h2>Explore Our Intercom Solutions</h2>
                </div>
            </div>
        </div>
        <div class="wraper">
            ...
            <div class="bottom-text">
                <span>Combine Our Intercom Solutions to Achieve Seamless Communication and Enhanced Security</span>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-6 col-12">
                <div class="left-content">
                    <div class="top_title">
                        ...
                        <p>
                            Whether you need a new intercom system installed, routine maintenance, or emergency repairs, Longtek Electronics Ltd offers
                            reliable solutions backed by years of experience in the industry. Contact us today to discuss your intercom system
                            requirements and how we can assist you in achieving seamless communication solutions.
                        </p>
                    </div>
                    <div class="item">
                        <div class="images">
